...
const opponents = [
  ...
  { id: "woodpecker", name: "交互に選ぶきつつき", emoji: "🐦", mask: "⬛", image: "assets/woodpecker.webp", description: "同じ場所をつつくように、分ける日とひとりじめの日を繰り返す相手でした。", strategyKey: "alternator", spawnWeight: 0.45, profile: { temperament: "森の幹をたたく音のように、決まった調子を持つ子です。", habit: "近づく日と離れる日を、ひとつずつ繰り返します。", memory: "あなたとの7日間にも、不思議なリズムが残っていました。" }, clueLines: { early: ["遠くで小さく木をたたく音が、一定の間で続いていた。", "せわしない気配が枝から幹へと移っていった。", "相手は短い間を刻むように動いていた。"], mid: ["昨日と違う日でも、同じリズムだけは崩れなかった。", "こちらの様子を見ながら、合図のような音を残していた。", "せかされるような足どりで、広場を行き来していた。"], late: ["乾いた音が幹に響き、影はまっすぐ奥へ消えた。", "去り際に木肌へ短い跡を残し、気配だけが上へ抜けた。", "最後の日も、一定の調子で森の奥へ戻っていった。"] } },
  { id: "boar", name: "いつもひとりじめするいのしし", emoji: "🐗", mask: "⬛", image: "assets/boar.webp", description: "毎日まっすぐにおやつへ向かい、分けることをほとんど考えない相手でした。", strategyKey: "alwaysTake", spawnWeight: 0.45, profile: { temperament: "目の前のおやつを見ると、まっすぐ走り出す子です。", habit: "分けることよりも、まず自分の手に抱えることを選びます。", memory: "広場には、勢いのある足あとと、少し遠い距離が残っていました。" }, clueLines: { early: ["土を踏む重たい足音が、まっすぐ近づいてきた。", "迷いのない気配が、広場の真ん中を横切った。", "草むらが大きく揺れ、相手は勢いのまま現れた。"], mid: ["昨日のことより、目の前へ進む力が先に見えた。", "荒い足どりでも、ためらいはほとんどなかった。", "距離を測るより先に、土を強く踏みしめていた。"], late: ["地面に深めの跡を残し、低い影が夕暮れへ進んでいった。", "去り際の足音は重く、森の奥まで長く響いた。", "最後の日も、まっすぐな気配だけが広場に残った。"] } },
  { id: "bear", name: "二度まで待つくま", emoji: "🐻", mask: "⬛", image: "assets/bear.webp", description: "一度だけなら待ってくれるけれど、続くと静かに身を守る相手でした。", strategyKey: "twoWarnings", spawnWeight: 0.45, profile: { temperament: "大きな体で、すぐには動かずに相手を見ている子です。", habit: "一度のことでは離れませんが、続くと少し距離を置きます。", memory: "待ってくれた日のあとに、あなたがどうするかを見ていました。" }, clueLines: { early: ["大きな気配が、急がずに広場の端で止まっていた。", "こちらを見る目は静かで、すぐには動かなかった。", "重たい足音が一度だけして、また沈黙に戻った。"], mid: ["少し待ってから手を動かし、昨日の空気を確かめていた。", "ゆっくりでも、食べものへの視線はまっすぐだった。", "許す日と守る日を、落ち着いた間で決めているようだった。"], late: ["重い足音が土を鳴らし、影はゆっくり森へ戻っていった。", "夕方の広場に大きな余韻だけが残った。", "最後まで急がず、確かな歩幅で去っていった。"] } },
  { id: "monkey", name: "多いほうへ寄るさる", emoji: "🐒", mask: "⬛", image: "assets/monkey.webp", description: "前の日だけでなく、これまでのあなたの選び方を見て寄ってくる相手でした。", strategyKey: "majorityFollower", spawnWeight: 0.45, profile: { temperament: "枝から枝へ渡るように、まわりの流れをよく見ている子です。", habit: "一日だけで決めず、これまで多かったほうへ少しずつ寄っていきます。", memory: "あなたが重ねた選び方を、森の上から眺めていました。" }, clueLines: { early: ["高い場所で小さな影が揺れ、こちらのしぐさを見ていた。", "一度まねしてから、すぐ別の動きに変えてみせた。", "試すような気配が枝の上を行き来していた。"], mid: ["昨日うまくいった手つきを、いたずらっぽく繰り返していた。", "相手は反応を待ちながら、次の手をすぐ試してきた。", "高い場所から降りては戻る、落ち着かない間合いだった。"], late: ["枝先が大きく揺れ、軽い足音が頭上を渡っていった。", "去り際、細い影が幹を蹴ってすっと消えた。", "最後の日も、真似と試しの気配が交互に残っていた。"] } }
];
